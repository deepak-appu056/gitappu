...
def locals():
    ...
    local_window.configure(bg='#333333')

    # Labels and Entry fields for different fields
    name_label = tk.Label(local_window, text="Name", bg='#333333', fg="#FFFFFF", font=("Arial", 16))
    name_label.pack(pady=10)
    name_entry = tk.Entry(local_window, font=("Arial", 14))
    name_entry.pack(pady=10)

    email_label = tk.Label(local_window, text="Email ID", bg='#333333', fg="#FFFFFF", font=("Arial", 16))
    email_label.pack(pady=10)
    email_entry = tk.Entry(local_window, font=("Arial", 14))
    email_entry.pack(pady=10)

    address_label = tk.Label(local_window, text="Address", bg='#333333', fg="#FFFFFF", font=("Arial", 16))
    address_label.pack(pady=10)
    address_entry = tk.Entry(local_window, font=("Arial", 14))
    address_entry.pack(pady=10)

    phone_label = tk.Label(local_window, text="Phone Number", bg='#333333', fg="#FFFFFF", font=("Arial", 16))
    phone_label.pack(pady=10)
    phone_entry = tk.Entry(local_window, font=("Arial", 14))
    phone_entry.pack(pady=10)

    college_label = tk.Label(local_window, text="College Name", bg='#333333', fg="#FFFFFF", font=("Arial", 16))
    college_label.pack(pady=10)
    college_entry = tk.Entry(local_window, font=("Arial", 14))
    college_entry.pack(pady=10)

    password_label = tk.Label(local_window, text="Password", bg='#333333', fg="#FFFFFF", font=("Arial", 16))
    ...
    def submit_local_info():
       if name_entry.get() and email_entry.get() and address_entry.get() and phone_entry.get() and college_entry.get() and password_entry.get():
            ...
            coll=college_entry.get()
            


            if name!="" and add!="" and phno!="" and email!="" and phno!="" and coll!="":
                c.execute("INSERT INTO pcdetails VALUES(:name,:address,:email,:college,:password) ",{
                        'name': name,
                        'address' :add,
                        'password' :"1",
                        'college' :coll,
